...
import DemoEngineProvider from '@/components/demo/DemoEngineProvider'
      ...
      <body className={`${lexend.variable} ${exo2.variable} bg-background text-text-secondary antialiased`}>
        <DemoEngineProvider>
          ...
          <div className="relative z-10 flex min-h-screen flex-col">
            <Navbar />
            <main className="flex-1 px-4 pb-16 pt-28 sm:px-8 md:px-12 lg:px-20 xl:px-32">{children}</main>
            <Footer />
          </div>
